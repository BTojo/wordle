...
:: ================================
:: Настройка пользовательского логирования Java
:: ================================
set "LOG_CONFIG=%PROJECT_DIR%\src\main\resources\logging.properties"
...
if exist "%LOG_CONFIG%" (
    echo Файл конфигурации логов найден: %LOG_CONFIG%
    set "JAVA_OPTS=-Djava.util.logging.config.file=%LOG_CONFIG%"
) else (
    echo ! ВНИМАНИЕ: logging.properties не найден!
)
